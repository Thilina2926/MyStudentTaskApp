...
class AddFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val addTask  : EditText= view.findViewById(R.id.addtask)
...
//            val addGPAETs =addGPAET.text.toString()
            ...
            val addtask =addTask.text.toString()


            if (!areFieldsNullOrEmpty(sidETs,addNameETs,addFacETs,addAgeETs,addYearETs,addGPAETs,addtask)){

                CoroutineScope(Dispatchers.IO).launch {

                        repository.insert(
                            Student(sidETs,addNameETs,addFacETs,addAgeETs,addYearETs,addGPAETs,addtask)
                        )
                        ...
                        requireActivity().runOnUiThread {
                            ...
                            val addtask = addTask.text.clear()
